...
export const GET: APIRoute = async () => {
  ...
  return new Response(
    [
      ...
      "Disallow: /search",
      "",
      "# The account pages. Nothing behind a session is public, and every response there is",
      "# already private, no-store — so this saves a fetch rather than protecting anything.",
      "# A crawler reaching /settings gets a redirect to /signin, which is a page about a",
      "# passkey ceremony and of no use to it either.",
      "Disallow: /settings",
      "Disallow: /signin",
      "Disallow: /auth/",
      "",
