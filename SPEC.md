...
**MUST.** `SPEC.md` не содержит сроков, порядка работ и оценок. `PLAN.md` не содержит архитектурных решений. При расхождении по существу прав `SPEC.md`; при расхождении по порядку работ прав `PLAN.md`.
...
**MUST.** Приоритетные типы контента — те, что произведены **исполнением**, а не генерацией, и потому невоспроизводимы читателем:
...
Эссе и обзоры допустимы, но не являются доказательством гипотезы.

**Обоснование.** Статья, за которой стоит выполненное действие, содержит информацию, которой у читающей модели нет. Именно это, а не факт публикации, создаёт причину читать.
